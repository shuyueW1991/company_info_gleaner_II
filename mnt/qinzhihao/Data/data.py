...
file = '/mnt/qinzhihao/Data/company_info_for_selection_' + now + '.csv'
opener = codecs.open(file, "r",encoding='utf-8', errors='ignore')
sel = pd.read_csv(opener, sep="|")
url_file = '/mnt/qinzhihao/Data/urlcrawler.txt'
...
try:
    os.remove('/mnt/qinzhihao/Data/old/urlcrawler.txt')
except:
    pass
shutil.move(url_file,'/mnt/qinzhihao/Data/old/')
...
try:
    shutil.move('/mnt/qinzhihao/spider_websites_content_frontera/url_list_short.txt','/mnt/qinzhihao/spider_websites_content_frontera/old')
except:
    print('brand new')

shutil.move('/mnt/qinzhihao/Data/url_list_short.txt','/mnt/qinzhihao/spider_websites_content_frontera')
