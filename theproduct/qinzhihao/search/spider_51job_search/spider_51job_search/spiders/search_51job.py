...
class Search51jobSpider(scrapy.Spider):
    ...
    def start_requests(self):
        self.search_start_url = "http://search.51job.com/jobsearch/search_result.php?keyword=%s"
        yield scrapy.Request(self.search_start_url % self.searchword, callback=self.parse_page)
