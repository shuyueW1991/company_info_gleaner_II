...
class DajiePipeline(object):
    ...
    def process_item(self, item, spider):
        sql = "insert into dajie_co(co_web_id,co_name,co_add,co_type, co_number,co_web_add) values ('{0}', '{1}', '{2}', '{3}', '{4}','{5}')"
        ...
        self.cursor.execute(sql.format(item['co_web_id'], item['co_name'], item['co_add'], item['co_type'], item['co_number'], item['co_web_add']))
        self.conn.commit()